...
public class PdksRestFulVeriAktarService implements Serializable {
	...
	public Response getMesaiPDKS(@QueryParam("sirketKodu") String sirketKodu, @QueryParam("yil") Integer yil, @QueryParam("ay") Integer ay, @QueryParam("tesisKodu") String tesisKodu) throws Exception {
		...
		try {
			if (sirketKodu != null && yil != null && ay != null)
				response = getFazlaMesaiJSON(sirketKodu, yil, ay, tesisKodu);
		} catch (Exception e) {
		}
		return response;
	}
	...
	public Response postMesaiPDKS() throws Exception {
		...
		if (data != null) {
			...
			Integer yil = (Integer) jsonMap.get("yil"), ay = (Integer) jsonMap.get("ay");
			if (sirketKodu != null && yil != null && ay != null)
				response = getFazlaMesaiJSON(sirketKodu, yil, ay, tesisKodu);
		}
		return response;
	 ...
	 * @return
	 */
	private Response getFazlaMesaiJSON(String sirketKodu, Integer yil, Integer ay, String tesisKodu) {
		Response response;
		String sonuc = "";
